...
export default function Events() {
  ...
  const {
    ...
    queryKey: ["busEvents", filterOptions],
    queryFn: () => GetBusEvents({ ...filterOptions }),
  });
  ...
  const columns = [
    ...
    },
    {
      ...
      key: "eventDate",
      render: (value, record) =>
        `${dayjs(value).locale(i18n?.language).format("DD MMMM YY")} , ${dayjs(
          record?.toDate
        )
