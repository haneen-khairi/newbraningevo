...
import { createAuthorities, fetchAuthorities, updateAuthorities } from "../../../services/authorities";
...
export default function EmailDomains() {
  ...
  const Mutation = useMutation({
    mutationFn: (values) =>
      mode == "create" ? createAuthorities(values) : updateAuthorities(values),
    onSuccess: () => {
  ...
  return (
    <>
      <ComplexTable
        tableTitle={t("theAuthorities")}
        addText={t("addAuthorities")}
        columns={columns}
