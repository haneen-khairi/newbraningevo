...
export default function HeadQuartersDrawer({mapDrawerOpen, onSubmit }) {
  ...
  useEffect(() => {
    if (mode=="update") {
      form.setFieldValue("buildingId",mapDrawerOpen.building.id)
      form.setFieldValue("floorId",mapDrawerOpen.floor.id)
      form.setFieldValue("companyId",mapDrawerOpen.company.id)
      form.setFieldValue("sideId",mapDrawerOpen.side.id)
      form.setFieldValue("roomId",mapDrawerOpen.room.id)
    }
  }, [])
