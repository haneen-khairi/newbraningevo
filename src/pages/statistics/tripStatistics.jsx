...
import { statistics, drivers, tripPerMonth } from "@/services/bus_statistics";
  ...
  return (
    <div className="flex flex-col gap-4 w-full">
      <div className="grid grid-cols-3 gap-3">
        <StatusButton
          bgcolor={"white"}
          count={generalStats["Number Of Bus Drivers"]}
          color={"#0070DF"}
          text={t("drivers")}
          icon={
            <svg
        ...
        <StatusButton
          bgcolor={"white"}
          count={generalStats["Number Of Busses"]}
          color={"#E98484"}
          text={t("buses")}
          icon={
            <svg
